      ...
      <div class="collapse navbar-collapse" id="navbarCollapse"> 
        <ul class="navbar-nav me-auto mb-2 mb-md-0"> 
            ...
            <!-- <a class="nav-link <?= ($_GET['page'] ?? '') == 'viewCart' ? 'active' : '' ?>" 
                href="/Day6/frontend/index.php?page=viewCart">Giỏ hàng</a> -->
            <a class="nav-link" href="/Day6/frontend/pages/viewCart.php">Giỏ hàng</a>
...
<style>
  body {
    padding-top: 70px; /* Điều chỉnh nếu navbar bạn cao hơn hoặc thấp hơn */
  }
</style>
